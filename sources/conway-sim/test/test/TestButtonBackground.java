...
public class TestButtonBackground {
    ...
    public TestButtonBackground() {
        ...
        frame.add(panel);
        final JButton button = new MyButton("button",
                new ImageIcon(ResourceLoader.loadImage("sandbox.button.on")));
        button.setHorizontalAlignment(SwingConstants.CENTER);
        button.setHorizontalTextPosition(SwingConstants.CENTER);
        button.setDisabledSelectedIcon(
                new ImageIcon(ResourceLoader.loadImage("sandbox.button.pressed")));
