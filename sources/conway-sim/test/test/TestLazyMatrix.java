...
public class TestLazyMatrix {
    ...
    @Test
    void testEquals() {
        assertEquals(new LazyMatrix<>(12, 6, "hi"), Matrices.unmodifiableMatrix(new LazyMatrix<>(12, 6, "hi")));
    }
    ...
    @Test
    void testCut() {
        assertEquals(new LazyMatrix<>(2, 2, 2), Matrices.cut(new LazyMatrix(10, 10, 2), 0, 1, 0, 1));
    }
}
